# @swenkerorg/cumque-blanditiis

__@swenkerorg/cumque-blanditiis__ is a javascript library that resolves references in [JSON schemas](https://json-schema.org/draft/2020-12/json-schema-core#name-introduction).
...
```bash
npm install @swenkerorg/cumque-blanditiis
```
...
const { RefResolver } = require('@swenkerorg/cumque-blanditiis')
